...
return [
    ...
    'alliance' => [
        ...
        'loca_deactivate_note'          => 'Do you really want to deactivate the alliance class #allianceClassName#? Reactivating it will cost #darkmatter# Dark Matter.',
        'no_manage_classes_perm'        => 'You do not have permission to manage the alliance class.',
        ...
        'msg_class_activated'           => 'Alliance class activated successfully',
        'msg_class_deactivated'         => 'Alliance class deactivated',
    ...
    'options' => [
        ...
        // Tab 4 – Extended > Account data export/import
        'section_account_data'                      => 'Account Data Backup',
        'export_data'                                => 'Export account data',
        'export_data_button'                        => 'Download backup (JSON)',
        'export_data_hint'                           => 'Download a backup of your empire (planets, buildings, research, fleet in the shipyard queue, items) as a JSON file. Keep it somewhere safe in case the server database ever needs to be reset.',
        'import_data'                                => 'Import account data',
        'import_data_hint'                           => 'Restore a previously downloaded backup into this account. This replaces all of your current planets with the ones in the backup file, so only use this right after re-registering with the same username and email the backup was made with.',
        'import_data_confirm'                        => 'I understand this will permanently replace all of my current planets with the ones in the backup file.',
        'import_data_button'                         => 'Restore backup',
        ...
        'msg_import_success'                        => 'Account data imported successfully.',
        'msg_import_invalid_file'                   => 'The uploaded file is not a valid account data backup.',
        'msg_import_unsupported_version'            => 'This backup file was made with an incompatible version of the export format and cannot be imported.',
        'msg_import_username_mismatch'               => 'This backup belongs to a different username/email than your current account. Re-register with the same username and email used in the backup before importing.',
        'msg_import_no_free_position'                => 'Could not find a free position in the universe to restore one of the planets in this backup.',
        'msg_import_processing_error'                => 'An unexpected error occurred while importing this backup. No changes were made to your account.',
        'msg_import_planet_relocated'                => 'Note: planet \':name\' was originally at :from, but that position is now occupied, so it was restored at :to instead.',
    ],
    ...
    'premium' => [
        ...
        'hire_button'                => 'Hire for 7 days',
        'hire_all_button'            => 'Hire all for 7 days',
        'active_until'               => 'Active until :date',
        'price_per_week'             => ':price DM / week',
        'confirm_hire'               => 'Do you want to hire this officer for 7 days for :price Dark Matter?',
        'confirm_hire_all'           => 'Do you want to hire all 5 officers for 7 days for :price Dark Matter?',
        'hired_success'              => 'Officer hired successfully',
        'hired_all_success'          => 'All officers hired successfully',
        'insufficient_dm'            => 'Not enough Dark Matter available! Do you want to buy some now?',
    ...
    'shop' => [
        ...
        'btn_buy'                  => 'Buy',
        'select_item_hint'         => 'Click an item to see its details.',
        // Item tiers
        'tier_gold'                => 'Gold',
        'tier_silver'              => 'Silver',
        'tier_bronze'              => 'Bronze',
